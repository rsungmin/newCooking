...
<body>
	...
	<div id="main">
		...
		<div class="wrap">
			<form action="${pageContext.request.contextPath}/member/memberFindId.me" method="post" name="loginform">
				<div class="wrap_input">
					<input type="text" name="member_name" class="form-control" id="member_name" placeholder="이름을 입력해주세요."> 
					<input type="text" name="member_phone" class="form-control" id="member_phone" placeholder="연락처를 입력해주세요.">
				</div>
				<br><input type="submit" value="아이디 찾기" id="submit">
			</form>
		</div>
		<ul>

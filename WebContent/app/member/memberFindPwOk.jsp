...
<body>
	...
	<div id="main">
		...
		<div class="wrap">			
				...
				<p>${member.getMember_name() }님의 비밀번호는 <strong> ${member.getMember_pw() } </strong>입니다.</p>					 					
				</div>			
		</div>
		<ul>
			...
			<li><a href="../app/member/memberFindId.jsp" class="button primary small">아이디 찾기</a></li>
		</ul>
	</div>
